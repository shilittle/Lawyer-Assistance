...
## [1.2.1] - 2026-09-12（发布标签 v1.2.1-r1）
...
- 独立复测续修补齐稳定文书身份、双窗口草稿冲突恢复、导出快照、三态模型能力和页/段落范围预检；修正 ALL 查询交集、递归 HTML 净化与安全进程诊断。
- 补齐 zune 依赖许可证正文。Windows 完整便携包、源码及校验清单见 v1.2.1-r1 Release；续修记录见 `docs/web/retest-1.2.1.md`。
