...
- v4 provenance source gates and the two builder suites pass 16/16; no final v4 bytes/hash exist before clean commit A deterministic rebuild, explicit approval, signing, short-root install/remeasure and GPU probe;
