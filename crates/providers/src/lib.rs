...
pub use adapter::{
    parse_chat_completion, provider_endpoint_origin, ChatTransport, OpenAiCompatibleAdapter,
...
pub use types::{
    ChatCompletion, ChatMessage, ChatMessageRole, ChatRequest, ChatUsage, ConnectionTest,
    ConnectionTestStatus, ProviderCapabilities, ProviderError, ProviderErrorKind, ProviderKind,
    ProviderOptions, ProviderProfile, ReasoningEffort,
};
