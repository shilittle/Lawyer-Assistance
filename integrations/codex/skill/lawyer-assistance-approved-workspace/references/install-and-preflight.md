...
4. Require an exact ordered 21-tool list. Keep wildcard denial/default write confirmation and merge `config.privacy-hardening.toml`; the broker must still deny every tool outside the App-issued grant groups.
