...
4. Require `tools/list` to match all 21 entries in [tool-catalog](tool-catalog.md), in order. An extra, missing, renamed, or reordered tool is a deployment failure. A listed tool is not authorized unless its App-issued grant group is present.
