...
5. Call `case_read_work_product` for the exact returned `wp_44444444444444444444444444444444` and version; require matching source references, hash, status, and placeholders.
6. Report only the verified work-product ID, version, and status.
